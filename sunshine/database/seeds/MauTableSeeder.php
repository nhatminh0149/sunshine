...
class MauTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        sort($colors); //Hàm sort(): sắp xếp mảng theo thứ tự abc.
        
        array_unshift($colors, "Phối màu"); //Hàm Array_unshift () chèn các phần tử mới vào một mảng. Các giá trị mảng mới sẽ được chèn vào đầu mảng.
