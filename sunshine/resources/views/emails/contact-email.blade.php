<table style="width: 100%; border-spacing: 0px">
    ...
    <tr>
        <th style="border-bottom: 1px solid black;border-right: 1px solid black;border-left: 1px solid black;text-align: right; padding: 5px;">SĐT khách hàng:</th>
        <td style="border-bottom: 1px solid black;border-right: 1px solid black; padding: 5px;">{{ $data['dienthoai'] }}</td>
    </tr>
    <tr>
